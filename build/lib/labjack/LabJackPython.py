...
The functions contained in this module are helper and device agnostic
functions. This module provides the base Device class which the U3, U6, and
UE9 classes inherit from.
    ...
    def __init__(self, ec = 0, errorString = ''):
        ...
        if not self.errorString:
            try:
                ...
                self.errorString = pString.value.decode('utf8')
            except:
