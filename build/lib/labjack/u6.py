...
"""
from labjack.LabJackPython import *
...
class U6(Device):
    ...
    def __init__(self, debug = False, autoOpen = True, **kargs):
        ...
        super(U6, self).__init__(None, devType = 6)
    ...
    def open(self, localId=None, firstFound=True, serial=None, devNumber=None,
        ...
        >>> myU6.open()
        """
        super(U6, self).open(6, firstFound=firstFound, serial=serial,
                    localId=localId, devNumber=devNumber,
